import {
  Badge, Button,
  ImageCard, ImageCardBody, ImageCardTitle, ImageCardDescription, ImageCardActions,
} from '../../src';
    ...
    <div className="space-y-8">
      ...
      <Section title="Gallery grid">
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {/* Simple body only */}
          <ImageCard src="https://images.unsplash.com/photo-1501785888041-af3ef285b470?w=600&h=340&fit=crop" alt="Swiss Alps">
            <ImageCardBody>
          ...
          {/* With action buttons */}
          <ImageCard src="https://images.unsplash.com/photo-1477959858617-67f85cf4f1df?w=600&h=340&fit=crop" alt="Downtown Skyline">
            <ImageCardBody>
            ...
            <ImageCardActions className="justify-between">
              ...
              <Button size="sm" intent="ghost"><Bookmark className="h-4 w-4" /></Button>
            </ImageCardActions>
          </ImageCard>

          {/* With metadata + badge */}
          <ImageCard src="https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=600&h=340&fit=crop" alt="Coastal Retreat">
            <ImageCardBody>
              <ImageCardTitle>Coastal Retreat</ImageCardTitle>
              <div className="text-primary-500 dark:text-primary-400 mt-1 space-y-1 text-sm">
                <p className="flex items-center gap-1"><MapPin className="h-3.5 w-3.5" /> Malibu, California</p>
                <p className="flex items-center gap-1"><Clock className="h-3.5 w-3.5" /> 3 days, 2 nights</p>
              </div>
            </ImageCardBody>
            <ImageCardActions className="justify-between">
              <Badge intent="success">Available</Badge>
              <Button size="sm"><ExternalLink className="h-4 w-4" /> Book Now</Button>
            </ImageCardActions>
          </ImageCard>
        </div>
      </Section>
