...
const leftMessages: ChatMessage[] = [
  { id: 1, sender: 'Charlie', avatar: 'https://ui-avatars.com/api/?name=Charlie&background=f59e0b&color=fff&size=40', content: 'Give me 5 minutes, grabbing coffee.', time: '9:02 AM' },
  { id: 2, sender: 'Alice', avatar: 'https://ui-avatars.com/api/?name=Alice&background=6366f1&color=fff&size=40', content: "Sure thing! I'll start preparing the board.", time: '9:03 AM' },
  { id: 3, sender: 'Bot', avatar: '🤖', content: 'Standup reminder: please share your updates before 9:30.', time: '9:05 AM' },
];
