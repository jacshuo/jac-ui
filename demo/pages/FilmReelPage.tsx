...
const photos: FilmReelPhoto[] = [
  {
    ...
    description: 'The valley was still asleep when the first light crept over the granite walls. I held my breath — afraid even the shutter click would break the silence.',
    metadata: {
      camera: 'Sony A7R IV',
  ...
  },
  {
    ...
    description: 'Every morning the fog writes a different story through these old-growth trees. This was a quiet Tuesday — just me and the ferns.',
    metadata: {
  ...
  },
  {
    ...
    description: 'The water was so still you could not tell where the mountain ended and the reflection began.',
    metadata: {
      camera: 'Nikon Z8',
      lens: '14-24mm f/2.8',
      aperture: 'f/11',
  ...
  },
  {
    ...
    description: 'An old farmer told me: come back at golden hour and the land will sing. He was right.',
    metadata: {
      camera: 'Canon EOS R5',
      lens: '85mm f/1.4L',
      aperture: 'f/2.0',
  ...
  },
  {
    ...
    description: 'Ten million lives pulsing behind glass and steel. From up here, every lit window is somebody\'s story.',
    metadata: {
      camera: 'Leica Q3',
      lens: '28mm f/1.7',
      aperture: 'f/4',
  ...
  },
  {
    ...
    description: 'The Dolomites do not care about your schedule. You wait for the light, or you miss it.',
    metadata: {
      camera: 'Nikon Z9',
      lens: '70-200mm f/2.8',
      aperture: 'f/8',
  ...
  },
  {
    ...
    description: 'Half a second of exposure turned the cascade into silk. Some things are only visible when you slow down.',
    metadata: {
  ...
  },
  {
    ...
    description: 'Lofoten in February — four hours of golden hour. The Arctic does not do ordinary light.',
    metadata: {
    ...
    <div className="space-y-10">
      ...
      <Section title="Film Strip">
        <p className="text-primary-500 dark:text-primary-400 mb-3 text-sm">
          Scroll horizontally through the strip. Click any frame to open the lightbox.
          Use scroll wheel to zoom, drag to pan, press <kbd className="rounded bg-primary-200 px-1 py-0.5 text-xs dark:bg-primary-700">I</kbd> for photo info.
        </p>
